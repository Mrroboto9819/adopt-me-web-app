...
<Modal bind:open onClose={onClose} maxWidth="max-w-4xl">
    {#if report}
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                    ...
                    <div class="flex flex-wrap gap-2 mb-4">
                        <button
                            ...
                            class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 disabled:opacity-50 text-sm font-medium"
                        >
                            Dismiss
                        </button>
                        <button
                            ...
                            class="px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-lg hover:bg-blue-200 dark:hover:bg-blue-900/50 disabled:opacity-50 text-sm font-medium"
                        >
                            Mark Reviewed
                        </button>
                        <button
                            ...
                            class="px-4 py-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-lg hover:bg-green-200 dark:hover:bg-green-900/50 disabled:opacity-50 text-sm font-medium"
                        >
                            Resolve
                        </button>
                    </div>
